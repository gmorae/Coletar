...
class Auth extends CI_Controller
{
	...
	public function index()
	{
		...
		else if (!$this->ion_auth->is_admin()) // remove this elseif if you want to enable this for non-admins
		{
			...
			show_error('Apenas para administrador ');
		}
		else
		{
	...
	public function change_password()
	{
		...
		if (!$this->ion_auth->in_group($group)) {
			$this->session->set_flashdata('message', 'Apenas usuarios cadastrados tem acesso a está página!');
			redirect('auth/login');
		}
	...
	public function edit_user($id)
	{
		...
		$this->form_validation->set_rules('cep', $this->lang->line('edit_user_validation_cep_label'), 'trim');
		$this->form_validation->set_rules('endereco', $this->lang->line('edit_user_validation_endereco_label'), 'trim|required');
		$this->form_validation->set_rules('rua', $this->lang->line('edit_user_validation_endereco_label'), 'trim');
		$this->form_validation->set_rules('cidade', $this->lang->line('edit_user_validation_cidade_label'), 'trim');
		$this->form_validation->set_rules('estado', $this->lang->line('edit_user_validation_estado_label'), 'trim');
		$this->form_validation->set_rules('bairro', $this->lang->line('edit_user_validation_bairro_label'), 'trim');
		$this->form_validation->set_rules('numero', $this->lang->line('edit_user_validation_numero_label'), 'trim');
		$this->form_validation->set_rules('complemento', $this->lang->line('edit_user_validation_complemento_label'), 'trim');
		...
		$this->data['endereco'] = [
			...
			'id'    => 'endereco',
			'type'  => 'text',
			'value' => $this->form_validation->set_value('endereco', $user->endereco),
		];
		$this->data['cep'] = [
			'name'  => 'cep',
			'id'    => 'cep',
			'type'  => 'text',
			'value' => $this->form_validation->set_value('company', $user->cep),
		];
		$this->data['phone'] = [
			'name'  => 'phone',
			'id'    => 'phone',
		...
		$this->data['numero'] = [
			...
			'id'    => 'numero',
			'type'  => 'text',
			'value' => $this->form_validation->set_value('numero', $user->numero),
		];
